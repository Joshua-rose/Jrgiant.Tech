...
const TriangleSection = styled.div`
  ...
  // position: relative;
  position: absolute;
  bottom: calc(${heights.header}px - 10px);
  left: 0;
  right: 0;
  z-index: -1;
...
const StyledFooter = styled.div`
  ...
  display: flex;
  @media (max-width: ${breakpoints.lg}px) {
    height: calc(300px + ${heights.header}px);
  }
  @media (max-width: ${breakpoints.md}px) {
    height: calc(190px + ${heights.header}px);
  }
`
...
function Footer(): ReactElement {
  return (
    <StyledFooter>
      <TriangleSection />
      <StyledFooterBottom />
      <StyledImg width="474" height="434" viewBox="0 0 474 434" fill="none" xmlns="http://www.w3.org/2000/svg">
        <ellipse cx="240.5" cy="74" rx="54.5" ry="74" fill="#FFEEB4" />
        <rect x="158" y="179" width="162" height="242" rx="46" fill="black" />
        <rect className="shirt" x="174" y="185" width="132" height="199" rx="38" fill={darken(0.4, colors.brand)} />
        ...
        <path
          ...
          stroke={darken(0.4, colors.brand)}
          strokeWidth="35"
        />
        <path
          className="shirt"
          d="M300.004 210.51C299.588 209.82 299.213 209.597 298.956 209.484C298.61 209.332 298.095 209.236 297.487 209.328C296.879 209.42 296.416 209.665 296.131 209.913C295.919 210.097 295.627 210.421 295.435 211.203L270.244 313.682C269.816 315.426 271.311 317.04 273.083 316.745L352.089 303.577C353.83 303.287 354.731 301.333 353.82 299.821L300.004 210.51Z"
          stroke={darken(0.4, colors.brand)}
          strokeWidth="35"
        />
        ...
        <g filter="url(#filter0_d)">
          <line x1="10" y1="333" x2="464" y2="333" stroke="#302E05" strokeWidth="12" strokeLinecap="square" />
        </g>
        <path
          d="M214 124C214 120.686 216.686 118 220 118H262C265.314 118 268 120.686 268 124V126C268 134.837 260.837 142 252 142H230C221.163 142 214 134.837 214 126V124Z"
          stroke="#8F7C5E"
          strokeWidth="8"
        />
        <ellipse cx="186.5" cy="75" rx="5.5" ry="14" fill="#FFEEB4" />
        <ellipse cx="294.5" cy="74" rx="5.5" ry="14" fill="#FFEEB4" />
        <rect x="192" y="62" width="40" height="16" rx="4" stroke="black" strokeWidth="4" />
        <rect x="249" y="62" width="40" height="16" rx="4" stroke="black" strokeWidth="4" />
        <line x1="232.982" y1="65.5" x2="247.018" y2="65.5" stroke="black" strokeWidth="4" />
        <defs>
          <filter id="filter0_d" x="0" y="327" width="474" height="20" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
      ...
      <FooterNav>{Links && Object.keys(Links).map(l => <Link to={Links[l]}>{l}</Link>)}</FooterNav>
    </StyledFooter>
  )
}
